...
model MotorTypeV_VSD_Ramp_StartUp
  ...
  Modelica.Mechanics.Rotational.Components.Inertia load_inertia5(J=1)
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={74,-40})));
  Modelica.Blocks.Sources.RealExpression Torque5(y=-(0.5*(15/100)*(1 - Motor5.s)
        ^2)*Motor5.T_b)
  ...
  MultiDomain.Motors.ThreePhase.PSAT.MotorTypeV Motor5
...
equation
  ...
  connect(aC2DC_and_DC2AC_uninitialized.p, bus4_mt5.p) annotation (Line(points=
