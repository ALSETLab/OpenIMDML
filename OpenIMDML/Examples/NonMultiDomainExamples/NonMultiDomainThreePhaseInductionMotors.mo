...
<li><code>Motor5.Pmotor</code></li>
    ...
    model NonMultiDomainCIM5 "Non Multi-Domain validation example for the CIM5 motor model"
      extends Modelica.Icons.Example;
      extends OpenIMDML.Examples.BaseClasses.ValidationPartial2;
      Modelica.Blocks.Sources.RealExpression SSCIM5(y=2*Modelica.Constants.pi*(
            SysData.fn))
        annotation (Placement(transformation(extent={{40,-46},{60,-26}})));
      NonMultiDomain.Motors.ThreePhase.PSSE.NMD_CIM5 CIM5(V_b=23000,
        T_nom=0.5)
        annotation (Placement(transformation(extent={{100,-10},{80,10}})));
    equation
      connect(SSCIM5.y, CIM5.we)
        annotation (Line(points={{61,-36},{96,-36},{96,-12}}, color={0,0,127}));
...
<li><code>CIM5.Pmotor</code></li>
    ...
    model NonMultiDomainCIM6 "Non Multi-Domain validation example for the CIM6 motor model"
      extends Modelica.Icons.Example;
      extends OpenIMDML.Examples.BaseClasses.ValidationPartial2;
      Modelica.Blocks.Sources.RealExpression SSCIM6(y=2*Modelica.Constants.pi*(
            SysData.fn))
        annotation (Placement(transformation(extent={{40,-46},{60,-26}})));
      NonMultiDomain.Motors.ThreePhase.PSSE.NMD_CIM6 CIM6(
        V_b=23000,
        Ctrl=true,
        T_nom=0.1) annotation (Placement(transformation(extent={{100,-10},{80,10}})));
    equation
      connect(SSCIM6.y, CIM6.we)
        annotation (Line(points={{61,-36},{96,-36},{96,-12}}, color={0,0,127}));
