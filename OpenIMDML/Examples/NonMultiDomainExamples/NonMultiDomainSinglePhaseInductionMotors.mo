...
package NonMultiDomainSinglePhaseInductionMotors "Simple systems to test out the non multi-domain single and dual phase motor models"
  ...
  model NonMultiDomainSPIM "Non Multi-Domain validation example for the single-phase induction motor (SPIM) model"
    ...
    OpenIMDML.NonMultiDomain.Motors.SinglePhase.NMD_SPIM SPIM(V_b = 230, P_0 = 40000, Q_0 = 40000, v_0 = 1, angle_0 = 0, R1 = 0.001, R2 = 0.005, X1 = 0.01, X2 = 0.01, Xm = 0.1, H = 0.1, a = 0.01, b = 0.02, c = 0.01) annotation(
      Placement(transformation(extent = {{40, -10}, {20, 10}})));
  equation
    connect(SPIM.p, load_bus.p) annotation(
      Line(points = {{20, 0}, {-16, 0}}, color = {0, 0, 255}));
    annotation(
      preferredView = "info",
      ...
      experiment(StopTime = 5, __Dymola_NumberOfIntervals = 5000, __Dymola_Algorithm = "Dassl"),
...
<li><code>SPIM.Qc</code></li>
  ...
  model NonMultiDomainDPIM "Non Multi-Domain validation example for the single-phase induction motor (SPIM) model"
    ...
    OpenIMDML.NonMultiDomain.Motors.SinglePhase.NMD_DPIM DPIM(Cc(displayUnit = "F") = 0.001, H = 0.005, Laux = 0.196, Lauxr = 0.000909, Lmain = 0.0806, Lmainr = 0.000588, Lr = 0.0000047, M_b(displayUnit = "V.A") = 15000000, Raux = 3.37, Rmain = 0.58, Rr = 0.0000376, V_b = 230, a = 0.0039, b = 0, c = 0, init = 1, switch_open_speed = 0.2) annotation(
      Placement(transformation(extent = {{40, -10}, {20, 10}})));
  equation
    connect(load_bus.p, DPIM.p) annotation(
      Line(points = {{-16, 0}, {20, 0}}, color = {0, 0, 255}));
    annotation(
      preferredView = "info",
      experiment(StopTime = 5, __Dymola_NumberOfIntervals = 10000, __Dymola_Algorithm = "Dassl"),
