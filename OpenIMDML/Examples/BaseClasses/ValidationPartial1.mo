...
partial model ValidationPartial1
  ...
  inner OpenIPSL.Electrical.SystemBase SysData(fn=60, S_b=100000)    annotation (Placement(transformation(extent={{60,60},
            {100,80}})));
equation
  ...
  connect(Line2.n,load_bus. p) annotation (Line(points={{-31,-16},{-28,-16},{-28,
          0},{-16,0}},
                   color={0,0,255}));
  connect(Fault.p,Line2. p) annotation (Line(points={{-45.6667,-40},{-54,-40},{
          -54,-16},{-49,-16}}, color={0,0,255}));
