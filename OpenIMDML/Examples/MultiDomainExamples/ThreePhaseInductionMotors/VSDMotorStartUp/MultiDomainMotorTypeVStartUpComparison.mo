...
model MultiDomainMotorTypeVStartUpComparison
  ...
  Modelica.Blocks.Sources.RealExpression TorqueEquation(y=-(0.1*(15/100)*(
        Motor5_with_VSD.s) + 0.5*(15/100)*(1 - Motor5_with_VSD.s)^2)*
        Motor5_with_VSD.T_b)
  ...
  MultiDomainModels.Motors.ThreePhase.PSAT.MotorTypeV Motor5_with_VSD(V_b=23000)
...
equation
  ...
  connect(AC2DC_and_DC2AC.n, Motor5_with_VSD.p)
    annotation (Line(points={{48,50},{60,50}}, color={0,0,255}));
  connect(torqueSensor3.tau, Motor5_with_VSD.mech_torque) annotation (Line(
        points={{94,39},{94,32},{76,32},{76,38}}, color={0,0,127}));
  connect(VfController.motor_speed, Motor5_with_VSD.wr)
    annotation (Line(points={{50,4},{64,4},{64,38}}, color={0,0,127}));
  connect(VfController.we, Motor5_with_VSD.we)
    annotation (Line(points={{50,-4},{70,-4},{70,38}}, color={0,0,127}));
  connect(Motor5_with_VSD.flange, torqueSensor3.flange_a)
