...
package MultiDomainExamples
  ...
  package SinglePhaseInductionMotors
    ...
    equation
      ...
      connect(inf_bus.p, Line.p) annotation (Line(points={{-66,0},{-60,0},{-60,
              16},{-41,16}},
                        color={0,0,255}));
      connect(load_bus.p, SPIM.p)
        annotation (Line(points={{4,0},{18,0}},  color={0,0,255}));
      connect(Line1.p, Line.p) annotation (Line(points={{-57,-16},{-60,-16},{
              -60,16},{-41,16}},
                        color={0,0,255}));
      connect(Line1.n, Line2.p)
        annotation (Line(points={{-39,-16},{-29,-16}},
                                                    color={0,0,255}));
      connect(Line2.n, load_bus.p) annotation (Line(points={{-11,-16},{-8,-16},
              {-8,0},{4,0}},
                       color={0,0,255}));
      connect(Fault.p, Line2.p) annotation (Line(points={{-21.6667,-40},{-34,
              -40},{-34,-16},{-29,-16}},
                              color={0,0,255}));
      ...
      connect(torqueSensor1.tau, SPIM.mech_torque) annotation (Line(points={{52,
              -11},{52,-20},{34,-20},{34,-12}}, color={0,0,127}));
    ...
    model DualPhaseInductionMotor
      ...
      OpenIPSL.Electrical.Events.PwFault Fault(
        ...
        X=0.01,
        t1=5,
        t2=5.1) annotation (Placement(transformation(extent={{-20,-50},{0,-30}})));
      OpenIPSL.Electrical.Branches.PwLine Line1(
        G=0,
        B=0,
        R=0.5*2.50000E-3,
      ...
      Modelica.Mechanics.Rotational.Sensors.TorqueSensor torqueSensor1
        annotation (Placement(transformation(extent={{50,-10},{70,10}})));
      Modelica.Mechanics.Rotational.Components.Inertia load_inertia1(J=0.001)
        annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=0,
            origin={90,0})));
      Modelica.Mechanics.Rotational.Sources.Torque torque1(useSupport=false)
        annotation (Placement(transformation(extent={{80,-50},{100,-30}})));
      Modelica.Blocks.Sources.RealExpression Torque1(y=-0.0002)
        annotation (Placement(transformation(extent={{40,-50},{60,-30}})));
    equation
      connect(gENCLS.p, inf_bus.p)
        annotation (Line(points={{-80,0},{-66,0}}, color={0,0,255}));
  ...
  package ThreePhaseInductionMotors
    ...
    package MotorValidation
      ...
      model MultiDomainMotorValidation
        ...
        MultiDomainModels.Motors.MD_ALL_IN_ONE_ThreePhaseMotor motor(M_b=
              15000000, redeclare
