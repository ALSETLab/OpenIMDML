...
model AC2DC_and_DC2AC_uninitialized
  ...
  Modelica.Electrical.Analog.Basic.Inductor Inductor(i(start=Il0),
                                                     L=Ldc)
...
protected
  ...
  parameter OpenIPSL.Types.Current Il0 = eps;
  parameter OpenIPSL.Types.PerUnit Vmotor0 = (3*sqrt(3)/(2*pi))*m0*v_0;
  parameter Real m0= 1;
