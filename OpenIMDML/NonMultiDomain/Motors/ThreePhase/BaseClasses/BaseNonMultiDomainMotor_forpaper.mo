...
partial model BaseNonMultiDomainMotor_forpaper
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
        ...
        Text(
          ...
          textString="pwpin"),
        Text(
          extent={{-76,-140},{-46,-180}},
          textColor={28,108,200},
          textString="we"),
        Text(
          extent={{48,-140},{78,-180}},
          textColor={28,108,200},
          textString="wr")}),    Diagram(coordinateSystem(preserveAspectRatio=false)));
end BaseNonMultiDomainMotor_forpaper;
